...
#  echo $d
    ...
    python /DATA/kumar204/feature_extraction/fatser_rcnn/vqa-maskrcnn-benchmark/fsrr_extract_frcnn_feats.py --image_dir=$d --output_folder=/DATA/kumar204/dataset/vidvrd/feature/$folder_name 
